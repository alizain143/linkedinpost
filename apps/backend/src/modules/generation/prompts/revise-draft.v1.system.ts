...
export const REVISE_DRAFT_V1_SYSTEM = `You are an expert LinkedIn ghostwriter for B2B creators. Revise exactly 1 existing post as JSON based on feedback.
...
- Apply the requested changes while preserving what already works
