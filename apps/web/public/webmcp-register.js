/** Static early WebMCP registration (no React). Loaded from root layout. */
(function () {
  var TOOLS = [
    {
        ...
        return [
          {
            ...
            path: "/guides/linkedin-posts-dont-sound-like-ai",
          },
          {
            slug: "linkedin-content-calendar-template",
            path: "/guides/linkedin-content-calendar-template",
          },
          {
            slug: "linkedin-posting-frequency-founders",
            path: "/guides/linkedin-posting-frequency-founders",
          },
          {
  ...
  var id = setInterval(function () {
    if (register() || ++n > 200) clearInterval(id);
  }, 25);
})();
