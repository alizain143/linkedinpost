...
const persona = getPersonaBySlug("founders");
...
export const metadata: Metadata = persona
  ? pageMetadata({
      ...
      path: "/for-founders",
      openGraphImage: "/for-founders/opengraph-image",
  ...
  return (
    <MarketingLayout>
          ...
          {page.pains.map((pain) => (
            ...
            >
              <div className="mb-[15px] flex h-11 w-11 items-center justify-center rounded-xl bg-[#eef2ff]">
                <MsIcon name="priority_high" size={23} className="text-[#4f46e5]" />
              </div>
      ...
      <section className="mx-auto max-w-[880px] px-7 pb-16 text-center">
        ...
        >
          Start free as a founder <MsIcon name="arrow_forward" size={19} />
        </Link>
      </section>
    </MarketingLayout>
  );
